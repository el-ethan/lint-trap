...
async function main() {
    ...
    if (results.exitCode === 1 && results.output) {
        ...
        console.log('You have some linting errors. Please see the output above and fix the errors before commiting, our ignore errors and commit using `git commit --no-verify`');
    }
